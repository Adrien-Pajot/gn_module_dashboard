...
class GnModuleSchemaConf(Schema):
   ...
   AFFICHER_SYNTHESE_PAR_ANNEE = fields.Boolean(default=True) 
   AFFICHER_SYNTHESE_PAR_ENTITE_GEO = fields.Boolean(default=True) 
   AFFICHER_SYNTHESE_PAR_RG_TAXO = fields.Boolean(default=True) 
   AFFICHER_SYNTHESE_PAR_CA = fields.Boolean(default=True) 
   AFFICHER_CONTACT_TAXONS = fields.Boolean(default=True) 
